...
namespace App\Filament\Resources\Superadmin\SuperadminUserKaryawans\Tables;
...
class SuperadminUserKaryawansTable
{
        ...
        return $table
            ->query(
                User::query()
                    ...
                    ->where('role', 'karyawan') // Exclude super admin from the list
