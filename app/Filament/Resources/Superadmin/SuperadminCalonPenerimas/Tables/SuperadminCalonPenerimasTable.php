...
namespace App\Filament\Resources\Superadmin\SuperadminCalonPenerimas\Tables;
...
class SuperadminCalonPenerimasTable
{
                    ...
                    ->action(function (CalonPenerima $record) {
                        ...
                        DB::transaction(function () use ($record) {
                            ...
                            $new_user = User::create([
                                ...
                                'instansi_penerima_id' => $record->instansi_penerima_id,
                                'name' => $record->name,
                                'email' => $record->email,
