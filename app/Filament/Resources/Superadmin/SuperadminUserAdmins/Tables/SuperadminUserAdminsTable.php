...
namespace App\Filament\Resources\Superadmin\SuperadminUserAdmins\Tables;
...
class SuperadminUserAdminsTable
{
        ...
        return $table
            ->query(
                User::query()
                    ...
                    ->where('role', 'admin') // Exclude super admin from the list
